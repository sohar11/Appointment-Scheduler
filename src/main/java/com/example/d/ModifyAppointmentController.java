...
public class ModifyAppointmentController implements Initializable {
    ...
    void saveAndReturn(ActionEvent event) throws IOException {
        ...
        LocalDateTime start;
        start = timeMGMT.convertSystemToUTC((startDateSelection.getValue().atTime(LocalTime.parse(startBox.getValue()))));
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        startBox.setValue(String.valueOf(highlightedAppointment.getStart()));
        endBox.setValue(String.valueOf(highlightedAppointment.getEnd()));
